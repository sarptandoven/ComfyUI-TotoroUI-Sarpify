...
class CLIPVisionEmbeddings(torch.nn.Module):
    ...
    def forward(self, pixel_values):
        ...
        if self.class_embedding is not None:
            embeds = torch.cat([totoro.ops.cast_to_input(self.class_embedding, embeds).expand(pixel_values.shape[0], 1, -1), embeds], dim=1)
        return embeds + totoro.ops.cast_to_input(self.position_embedding.weight, embeds)
